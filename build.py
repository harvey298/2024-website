...
with open("./projects.toml", "r") as f:
    ...
    for (i, project) in enumerate(projects["project"]):
        ...
        if new:
            priorities += f'{i},'
            fluf = '<div class="badge new" title="New means new to Archivist" >New</div>'
    ...
    data_to_write = data_to_write.replace("${priorities}", priorities)
...
buffer = """ // DO NOT CHANGE - THIS IS GENERATED BY BUILD.PY
...
with open("./changelog/main.js", "w+") as f:
    f.write(buffer)